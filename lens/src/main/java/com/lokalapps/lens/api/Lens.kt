...
import com.lokalapps.lens.internal.core.LensImpl
import com.lokalapps.lens.internal.core.NoOpLens
...
object Lens {
  ...
  fun wrapWebViewClient(client: android.webkit.WebViewClient?): android.webkit.WebViewClient {
    return com.lokalapps.lens.internal.interceptors.LensWebViewClient.wrap(client)
  }
  ...
  fun wrapWebSocketListener(listener: okhttp3.WebSocketListener): okhttp3.WebSocketListener {
    return com.lokalapps.lens.internal.interceptors.LensWebSocketListener.wrap(listener)
  }
