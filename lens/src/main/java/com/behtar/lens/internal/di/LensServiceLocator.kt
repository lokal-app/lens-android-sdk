package com.behtar.lens.internal.di

import android.content.Context
import com.behtar.lens.internal.data.repository.AnalyticsLogRepository
import com.behtar.lens.internal.data.repository.AnalyticsLogRepositoryImpl
import com.behtar.lens.internal.data.repository.DatabaseRepository
import com.behtar.lens.internal.data.repository.DatabaseRepositoryImpl
import com.behtar.lens.internal.data.repository.ExceptionLogRepository
import com.behtar.lens.internal.data.repository.ExceptionLogRepositoryImpl
import com.behtar.lens.internal.data.repository.NetworkLogRepository
import com.behtar.lens.internal.data.repository.NetworkLogRepositoryImpl
import com.behtar.lens.internal.data.repository.WebSocketLogRepository
import com.behtar.lens.internal.data.repository.WebSocketLogRepositoryImpl
import com.behtar.lens.internal.data.repository.WebViewLogRepository
import com.behtar.lens.internal.data.repository.WebViewLogRepositoryImpl
...
import com.behtar.lens.internal.domain.usecase.database.DeleteRowUseCase
import com.behtar.lens.internal.domain.usecase.database.ExecuteQueryUseCase
import com.behtar.lens.internal.domain.usecase.database.GetDatabasesUseCase
import com.behtar.lens.internal.domain.usecase.database.GetTableSchemaUseCase
import com.behtar.lens.internal.domain.usecase.database.GetTablesUseCase
import com.behtar.lens.internal.domain.usecase.database.QueryTableUseCase
import com.behtar.lens.internal.domain.usecase.database.UpdateCellUseCase
