 ...
 * - onRestartRequested() fires a launch intent before killProcess() to guarantee a true cold
 *   start, so the DI graph (and any singleton base URLs) is rebuilt from scratch.
...
class SampleEnvironmentProvider(private val context: Context) : EnvironmentProvider {
    ...
    companion object {
        ...
        /**
         * Call this from your network layer's base URL provider at startup.
         * Both this and [SampleEnvironmentProvider] must read the same prefs file and key.
         */
